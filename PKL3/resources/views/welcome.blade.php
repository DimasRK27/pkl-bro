...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .sm\:text-left{text-align:left}.sm\:text-right{text-align:right}}@media (min-width:768px){
            .md\:border-t-0{border-top-width:0}
            .md\:border-l{border-left-width:1px}.md\:grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (min-width:1024px){
...
<div class="wrapper">
    <!-- Sidebar Constructor -->
    <div class="constructor" align="center">
        <h1>Dashboard</h1>

        <p>
        <button><a href="">Jumlah SOP</a></button>
        <button><a href="">Jumlah Panduan</a></button></p>
        <p><button><a href="">Jumlah Standar</a></button></p>
